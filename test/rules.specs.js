...
describe('Rules', () => {
    it('Load Rules', function () {
        let order = createInstance(schemaOrder, { $create: true, lines: [{ codeItem: 'A' }, { codeItem: 'B' }] });
    ...
    it('Load rule', function () {
        let order = createInstance(schemaOrder, { lines: [{ codeItem: 'A', tauxTVA: 20 }, { codeItem: 'B', tauxTVA: 21 }] });
    ...
    it('Validation rules', function () {
        let order = createInstance(schemaOrder, { lines: [{ codeItem: 'A', tauxTVA: 20 }, { codeItem: 'B', tauxTVA: 21 }, { codeItem: 'B', tauxTVA: 30 }] });
        let res = order.validate();
    ...
    it('Propagation rules', function () {
        let order = createInstance(schemaOrder, { $create: true });
